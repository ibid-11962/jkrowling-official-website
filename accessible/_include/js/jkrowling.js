...
function writeswf(flashmovie,width,height,flashvars,transparent)
{
	...
	document.write('<embed src="'+flashmovie+'" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="'+width+'" height="'+height+'" align="top" flashvars="'+flashvars+'"');
	if (transparent==true)
	{
