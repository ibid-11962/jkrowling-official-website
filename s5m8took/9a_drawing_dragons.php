...
<param name="movie" value="../f7b3qash/9a_drawing_dragons.swf">
<param name="quality" value="high">
<param name="menu" value="false">
<param name="flashvars" value="language=<?php echo $lang; ?>">
<embed src="9a_drawing_dragons.swf" menu="false" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="100%" height="100%" flashvars="language=<?php echo $lang; ?>" align="top">
</embed>
</object></noscript><script language="JavaScript" type="text/javascript">
<!--
writeswf("9a_drawing_dragons.swf","100%","100%","language=<?php echo $lang; ?>");
//-->
</script></td>
</tr>
</table>
