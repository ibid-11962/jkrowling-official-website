...
<!-- email: info@lightmaker.com -->
<!-- tel: +44 (0)1892 615015 -->
<!-- code copyright Lightmaker 2004 -->
...
<!-- Enter JavaScripts Here -->
</script>
</head>
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" valign="middle" bgcolor="#FFFFFF"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0" width="513" height="710">
        <param name=movie value="12b_drawing_sortinghat_0.swf">
        <param name=quality value=high>
        <param name="menu" value="false">
        <embed src="12b_drawing_sortinghat_0.swf" menu="false" quality=high pluginspage="http://www.macromedia.com/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="513" height="710">
        </embed> 
      </object></td>
  </tr>
</table>
